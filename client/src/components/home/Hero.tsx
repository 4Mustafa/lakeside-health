      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl font-bold font-heading leading-tight mb-4 text-primary">Lakeside Health</h1>
            <p className="text-lg md:text-xl mb-8 text-neutral-700">We offer comprehensive healthcare services designed to help individuals and families maintain their health and wellbeing in their communities.</p>
