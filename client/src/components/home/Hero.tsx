...
const Hero = () => {
  return (
    <section id="home" className="bg-gradient-to-r from-calming-blue to-calming-blue/80 text-white">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Link href="/services">
                <a className="bg-white text-calming-blue hover:bg-warm-sand font-semibold px-6 py-3 rounded-lg transition-colors text-center">Our Services</a>
              </Link>
              <Link href="/referral">
          ...
          <div className="md:w-1/2">
            <svg className="w-full h-auto" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="800" height="600" rx="10" fill="#F2E8D5" />
              <path d="M400 100L600 300H500V500H300V300H200L400 100Z" fill="#3B7EA1" fillOpacity="0.8" />
              <rect x="325" y="350" width="50" height="50" rx="5" fill="white" />
              <rect x="425" y="350" width="50" height="50" rx="5" fill="white" />
              <rect x="325" y="425" width="150" height="75" rx="5" fill="#5BA89D" />
              <circle cx="200" cy="200" r="50" fill="#F2E8D5" />
              <path d="M650 150C650 177.614 627.614 200 600 200C572.386 200 550 177.614 550 150C550 122.386 572.386 100 600 100C627.614 100 650 122.386 650 150Z" fill="#D4A055" />
            </svg>
          </div>
        </div>
      </div>
