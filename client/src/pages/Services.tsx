      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link href="/referral">
              <a className="inline-block bg-primary text-white hover:text-white hover:bg-[#4ECDC4] hover:border-transparent font-semibold px-6 py-3 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md">Make a Referral Today</a>
            </Link>
          </div>
        </div>
      </section>
